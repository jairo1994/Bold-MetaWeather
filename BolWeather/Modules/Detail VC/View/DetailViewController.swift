...
class DetailViewController: UIViewController {
    ...
    func addBarButton(){
        let play = UIBarButtonItem(image: UIImage(named: viewModel.isFAvorite() ? "favorite" : "notfavorite"), style: .done, target: self, action: #selector(addOrRemoveFromFav))
